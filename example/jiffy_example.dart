...
//  FORMATTING DATES
  Jiffy([2019, 10, 19])
      .format('MMMM do yyyy, h:mm:ss a'); // October 19th 2019, 7:00:53 PM
...
//  RELATIVE TIME
  ...
  var jiffy1 = Jiffy()..startOf(Units.DAY);
  jiffy1.fromNow(); // 19 hours ago

  var jiffy2 = Jiffy()..endOf(Units.DAY);
  jiffy2.fromNow(); // in 5 hours

  var jiffy3 = Jiffy()..startOf(Units.HOUR);
  jiffy3.fromNow(); // 9 minutes ago

//  MANIPULATING DATES
  var jiffy4 = Jiffy()..add(duration: Duration(days: 1));
  jiffy4.yMMMMd; // October 20, 2019

  var jiffy5 = Jiffy()..subtract(days: 1);
